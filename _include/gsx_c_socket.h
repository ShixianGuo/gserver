...
#include <vector>       #include <list>         #include <sys/epoll.h>  #include <sys/socket.h>
#include <pthread.h>    #include <semaphore.h>  #include <atomic>       #include <map>
#include "gsx_comm.h"

#define GSX_LISTEN_BACKLOG 511 #define GSX_MAX_EVENTS 512
